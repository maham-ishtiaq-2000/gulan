          ...
          <Navigation></Navigation>
           <Box sx={{ width: '100%', typography: 'body1' }} >
            <TabContext value={value}>
                <Box sx={{ marginLeft : '40%' , borderColor: 'divider' }}>
                <TabList onChange={handleChange} aria-label="lab API tabs example" >
                    <Tab style={{fontSize : '15px' }} label="All Posts" value="1" />
                    <Tab style={{fontSize : '15px' }} label="Customers Posts" value="2" />
                ...
                <TabPanel value="2">
                       {customizedData.map((item) => {
                           return(
                            <div className='container' className='col-10 mx-auto mt-3 pt-3'>
                                <div>
                                  <CustomersCard item={item}/>
                                </div>
